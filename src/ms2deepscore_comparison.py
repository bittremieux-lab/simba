...
class MS2DeepScoreComparison:
    ...
    def compute_ms2deepscore(molecule_pairs, 
        ...
        for i in tqdm(molecule_pairs_indexes):
            ...
            spectrum_found_0_ms = next(s for s, t in zip(original_spectrum_match_hash, target_hashes_subset) if t == hash_0)
            spectrum_found_1_ms = next(s for s, t in zip(original_spectrum_match_hash, target_hashes_subset) if t == hash_1)
