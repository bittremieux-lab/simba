...
class Spec2VecComparison:
    ...
    def get_spec2vec_similarity(model_spec2vec_file):
        ...
        return Spec2Vec(model=model, intensity_weighting_power=0.5,
    ...
    def compute_scores_tanimoto(molecule_pairs, preprocessed_spectrums, target_hashes_subset, spec2vec_similarity):
        tanimotos= []
        scores= []
