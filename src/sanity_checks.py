...
class SanityChecks:
    ...
    @staticmethod
    def sanity_checks_ids(molecules_pairs_train, molecules_pairs_val, molecules_pairs_test, uniformed_molecule_pairs_test):
        '''
        ...
        ids_uni_test = [s.spectrum_hash for s in uniformed_molecule_pairs_test.spectrums]
        ...
        return not(is_any_train_in_val + is_any_train_in_test + is_any_train_in_uni_test)

    @staticmethod
    def sanity_checks_bms(molecules_pairs_train, molecules_pairs_val, molecules_pairs_test, uniformed_molecule_pairs_test):
        ...
        bms_uni_test = [s.murcko_scaffold for s in uniformed_molecule_pairs_test.spectrums]
        ...
        return not(is_any_bms_train_in_val + is_any_bms_train_in_test + is_any_bms_train_in_uni_test)
