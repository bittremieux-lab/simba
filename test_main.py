...
dataset_train = LoadData.from_molecule_pairs_to_dataset(m_train[0:64*32])
...
train_sampler = WeightedRandomSampler(weights=weights_tr[0:64*32], num_samples=len(dataset_train), replacement=True)
