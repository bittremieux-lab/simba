...
uniformed_molecule_pairs_test = uniformed_molecule_pairs_test_1 +uniformed_molecule_pairs_test_2
...
sanity_check_ids= SanityChecks.sanity_checks_ids(molecules_pairs_train, molecules_pairs_val, molecules_pairs_test, uniformed_molecule_pairs_test)
sanity_check_bms= SanityChecks.sanity_checks_bms(molecules_pairs_train, molecules_pairs_val, molecules_pairs_test, uniformed_molecule_pairs_test)

if (sanity_check_ids and sanity_check_bms):
    print('Sanity check passed')
    write_data(dataset_path_out, 
                        all_spectrums_train=None, 
                        all_spectrums_val=None, 
                        all_spectrums_test=None, 
