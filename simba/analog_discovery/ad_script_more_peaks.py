...
if USE_TFS_SPECTRA:
    OUTPUT_PICKLE_FILE = os.path.join(OUTPUT_DIR, "analog_discovery_simba_modified_cosine_results_tf_more_peaks.pkl")
else:
    OUTPUT_PICKLE_FILE = os.path.join(OUTPUT_DIR, "analog_discovery_simba_modified_cosine_results_msnlib.pkl")
...
cfg.data.preprocessing.min_n_peaks=18
