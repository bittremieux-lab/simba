...
import sys
## PARAMETERS
input_file = "/scratch/antwerpen/209/vsc20939/data/dataset_processed_augmented_20231207.pkl"
...
all_spectrums_test = all_spectrums_test + [m.spectrum_object_1 for m in molecular_pairs_test_input]



#all_spectrums_test = dataset['all_spectrums_test']

molecule_pairs_test = TrainUtils.compute_all_tanimoto_results(all_spectrums_test[0:10000], max_combinations=test_molecules, use_tqdm=use_tqdm)
