...
if load_train_val_test_data:
    ...
    if load_gnps_spectra:
        ...
        all_spectrums_gnps = loader_saver.get_all_spectrums(gnps_path,max_number_spectra_gnps, use_tqdm=use_tqdm, use_nist=False, config=config)
    ...
    if load_nist_spectra:
        ...
        all_spectrums_nist = loader_saver.get_all_spectrums(nist_path,max_number_spectra_nist, use_tqdm=use_tqdm, use_nist=True, config=config)
...
print(f'Current time: {datetime.now()}')
number_of_pairs= TrainUtils.compute_number_of_pairs(all_spectrums, max_combinations=train_molecules, use_tqdm=use_tqdm, max_mass_diff=config.MAX_MASS_DIFF)
print(f'Current time: {datetime.now()}')
