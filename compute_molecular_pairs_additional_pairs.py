...
print(f'Current time: {datetime.now()}')
molecule_pairs_train= TrainUtils.compute_all_tanimoto_results_sequential(all_spectrums_train, max_combinations=train_molecules, use_tqdm=use_tqdm, max_mass_diff=config.MAX_MASS_DIFF, min_mass_diff=config.MIN_MASS_DIFF)
