...
# load spectra
all_spectrums_janssen = LoadData.get_all_spectrums(janssen_path,
...
molecule_pairs= TrainUtils.compute_all_tanimoto_results(all_spectrums_janssen, max_combinations=max_combinations, use_tqdm=use_tqdm, max_mass_diff=config.MAX_MASS_DIFF, min_mass_diff=config.MIN_MASS_DIFF)
