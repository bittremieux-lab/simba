#!/bin/bash
#SBATCH -J simba_train_008_1_cosine_baseline
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_1_cosine_baseline_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_1_cosine_baseline_1gpu/%x_%j.err

# Experiment 008_1_cosine_baseline: one entry in the head_mode ablation series (008_1..008_5).
...
#   - model.tasks.cosine_similarity.head_mode=cosine_relu
#     2-layer projection head, final ReLU, cosine similarity — the current/original SIMBA head (control)
...
echo "===== SIMBA Training 008_1_cosine_baseline: head_mode=cosine_relu · official split, fixed MCES · no metadata · 1x H200 · bs=2048 · 32-true · lr=0.0001 · 24 epochs ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/008_1_cosine_baseline_1gpu
