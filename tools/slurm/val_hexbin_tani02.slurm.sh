...
#SBATCH --mem=80G
#SBATCH -o /home/nkubrakov/simba/logs/simba_inf_tani02_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_inf_tani02_%j.err

set -uo pipefail

echo "===== Inference: max(Gaetan lb, HDF5) + Tani>=0.2 filter ====="
...
CHECKPOINT="${EXP_DIR}/checkpoint-epoch=05-step=45000.ckpt"
OUTPUT_DIR="${EXP_DIR}/val_hexbin_step45k"
