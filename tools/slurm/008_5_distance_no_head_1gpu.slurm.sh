#!/bin/bash
#SBATCH -J simba_train_008_5_distance_no_head
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_5_distance_no_head_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_5_distance_no_head_1gpu/%x_%j.err

# Experiment 008_5_distance_no_head: one entry in the head_mode ablation series (008_1..008_5).
...
#   - model.tasks.cosine_similarity.head_mode=distance_no_head
#     no projection layers; L2-normalized Euclidean distance on encoder embeddings mapped through exp(-dist) (MaLSTM / Chopra-Hadsell-LeCun style)
...
echo "===== SIMBA Training 008_5_distance_no_head: head_mode=distance_no_head · official split, fixed MCES · no metadata · 1x H200 · bs=2048 · 32-true · lr=0.0001 · 24 epochs ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/008_5_distance_no_head_1gpu
