#!/bin/bash
#SBATCH -J simba_train_008_6_corn_baseline
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_6_corn_baseline_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_6_corn_baseline_1gpu/%x_%j.err

# Experiment 008_6_corn_baseline: CORN ordinal-classification head (Shi, Cao & Raschka,
# 2021/2023) on binned raw MCES, replacing the cosine/distance regression
# heads from the 008_1..5 series. no MLP, |emb0-emb1| only — simplest CORN variant.
...
echo "===== SIMBA Training 008_6_corn_baseline: head_mode=corn (mlp=false, product=false) · official split, fixed MCES · no metadata · 1x H200 · bs=2048 · 32-true · lr=0.0001 · 24 epochs ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/008_6_corn_baseline_1gpu
