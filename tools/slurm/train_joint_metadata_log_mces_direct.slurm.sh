#!/bin/bash
#SBATCH -J simba_train_logmces_direct
#SBATCH -p seven_days
...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_logmces_direct_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_logmces_direct_%j.err

set -uo pipefail

echo "===== SIMBA Training: metadata + direct log-MCES head ====="
