#!/bin/bash
#SBATCH -J simba_retrieval_008_2_cosine_no_head_1gpu
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_2_cosine_no_head_1gpu/retrieval_best_official_spearman/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_2_cosine_no_head_1gpu/retrieval_best_official_spearman/%x_%j.err

# Retrieval eval for 008_2_cosine_no_head_1gpu (head_mode=cosine_no_head), using the checkpoint at
# this run's own best val_mces_spearman/official point (found from
# metrics.csv, not the scaffold-loss-selected best_model.ckpt): checkpoint-epoch=02-step=24000.ckpt.
...
echo "===== SIMBA Retrieval: 008_2_cosine_no_head_1gpu (head_mode=cosine_no_head), checkpoint=checkpoint-epoch=02-step=24000.ckpt ====="
