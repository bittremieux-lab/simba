#!/bin/bash
#SBATCH -J simba_retrieval_iceberg_008_3
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_3_cosine_linear_head_1gpu/retrieval_iceberg/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_3_cosine_linear_head_1gpu/retrieval_iceberg/%x_%j.err

# SIMBA+ICEBERG retrieval for 008_3 (head_mode=cosine_linear_head), checkpoint=checkpoint-epoch=01-step=15000.ckpt.
...
echo "===== SIMBA+ICEBERG Retrieval: 008_3 (head_mode=cosine_linear_head) ====="
