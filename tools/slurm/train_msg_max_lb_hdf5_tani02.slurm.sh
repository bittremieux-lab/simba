...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_tani02_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_tani02_%j.err

set -uo pipefail

echo "===== SIMBA Training: MSG splits, max(Gaetan lb, HDF5) + Tanimoto>=0.2 filter, clip-40 ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_max_lb_hdf5_tani02_mces40
