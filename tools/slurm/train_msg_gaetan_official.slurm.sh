#!/bin/bash
#SBATCH -J simba_gaetan_official
#SBATCH -p one_day
...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_gaetan_official_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_gaetan_official_%j.err

set -uo pipefail

echo "===== SIMBA Training: MSG official splits, Gaetan lb_matrix distances, clip-40 ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_gaetan_official_mces40
