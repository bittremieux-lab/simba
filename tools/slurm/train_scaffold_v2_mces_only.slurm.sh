...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_sv2_mces_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_sv2_mces_%j.err

set -uo pipefail

echo "===== SIMBA Training: scaffold_v2 — MCES only ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/scaffold_v2_mces_only
