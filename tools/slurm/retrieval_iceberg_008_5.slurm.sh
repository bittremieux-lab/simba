#!/bin/bash
#SBATCH -J simba_retrieval_iceberg_008_5
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_5_distance_no_head_1gpu/retrieval_iceberg/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_5_distance_no_head_1gpu/retrieval_iceberg/%x_%j.err

# SIMBA+ICEBERG retrieval for 008_5 (head_mode=distance_no_head), checkpoint=checkpoint-epoch=01-step=12000.ckpt.
...
echo "===== SIMBA+ICEBERG Retrieval: 008_5 (head_mode=distance_no_head) ====="
