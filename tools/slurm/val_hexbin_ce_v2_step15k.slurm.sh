...
#SBATCH --mem=80G
#SBATCH -o /home/nkubrakov/simba/logs/simba_inf_ce_v2_step15k_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_inf_ce_v2_step15k_%j.err

set -uo pipefail

echo "===== Inference: clip-40 + metadata CE v2 @ step 15k ====="
...
EXP_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_scaffold_split_mces40_metadata_ce_v2
CHECKPOINT="${EXP_DIR}/checkpoint-epoch=01-step=15000.ckpt"
OUTPUT_DIR="${EXP_DIR}/val_hexbin_step15k"
