#!/bin/bash
#SBATCH -J simba_inf_tani02_100k
#SBATCH -p one_hour
...
#SBATCH --mem=80G
#SBATCH -o /home/nkubrakov/simba/logs/simba_inf_tani02_100k_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_inf_tani02_100k_%j.err

set -uo pipefail

echo "===== Inference: max(Gaetan lb, HDF5) + Tani>=0.2 filter @ step 100k ====="
echo "Job ID: $SLURM_JOB_ID  Node: $SLURM_NODELIST  Date: $(date)"
nvidia-smi

PREPRO_DIR=/mnt/data/nkubrakov/massspecgym/preprocessing_msg_max_lb_hdf5_tani02
EXP_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_max_lb_hdf5_tani02_mces40
CHECKPOINT="${EXP_DIR}/checkpoint-epoch=11-step=100000.ckpt"
OUTPUT_DIR="${EXP_DIR}/val_hexbin_step100k"
