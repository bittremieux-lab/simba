#!/bin/bash
#SBATCH -J simba_train_014_2_budget7564_T12
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T12_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T12_1gpu/%x_%j.err
...
# the other 16,446, same count for every T). T=12 (this file) means a
# minimum-distance floor of 12 on top of the closest-to-CASMI selection --
# distance range [12.0, 17.5] (verified when the exclusion
...
echo "===== SIMBA Training 014_2 budget-matched sweep, T=12 (7,564 closest-to-CASMI train molecules, min_dist>=12) ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T12_1gpu
EXCLUDE_FILE=/sofia/projects/2026_053/simba_project/data/analog_discovery/train_exclude_smiles_budget7564_T12.txt
