#!/bin/bash
#SBATCH -J simba_train_lr3e5_bs2048
#SBATCH -p one_day
...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_lr3e5_bs2048_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_lr3e5_bs2048_%j.err

# Same as job 8041 (own val weights, no early stopping, exact MCES, no metadata)
# but lr=3.33e-5 and batch_size=2048 to match scaffold-v2 hyperparameters.

set -uo pipefail

echo "===== SIMBA Training: exact MCES · no metadata · lr=3.33e-5 · bs=2048 ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_exact_mces_1020_no_meta_lr3e5_bs2048
