#!/bin/bash
#SBATCH -J simba_train_008_4_distance_linear_head
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu/%x_%j.err

# Experiment 008_4_distance_linear_head: one entry in the head_mode ablation series (008_1..008_5).
...
#   - model.tasks.cosine_similarity.head_mode=distance_linear_head
#     2-layer projection head, no final activation, L2-normalized Euclidean distance mapped through exp(-dist)
...
echo "===== SIMBA Training 008_4_distance_linear_head: head_mode=distance_linear_head · official split, fixed MCES · no metadata · 1x H200 · bs=2048 · 32-true · lr=0.0001 · 24 epochs ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu
