#!/bin/bash
#SBATCH --job-name=simba-muon-experiment
#SBATCH --nodes=1
...
#SBATCH --output=logs/muon_experiment_%j.log
#SBATCH --error=logs/muon_experiment_%j.err

# SIMBA Training with Muon Optimizer (Experiment)
...
EXPERIMENT_DIR="experiments/results/muon_experiment_$(date +%Y%m%d_%H%M%S)"
...
# Time the training
echo "Starting training with Muon optimizer..."
SECONDS=0
