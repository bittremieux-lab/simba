...
#SBATCH --mem=64G
#SBATCH -o /home/nkubrakov/simba/logs/simba_ret_ce_v2_step60k_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_ret_ce_v2_step60k_%j.err

# SIMBA retrieval benchmark: clip-40 + metadata CE v2 · step 60k (job 7955)
...
INTERMEDIATES_DIR=/mnt/data/nkubrakov/experiments_3_dataset/retrieval/msg_ce_v2_step60k
OUTPUT_TSV=/home/nkubrakov/simba/results/simba_retrieval_ce_v2_step60k.tsv

mkdir -p /home/nkubrakov/simba/results

echo "===== SIMBA Retrieval: clip-40 + metadata CE v2 · step 60k ====="
