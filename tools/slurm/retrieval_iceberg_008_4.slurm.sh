#!/bin/bash
#SBATCH -J simba_retrieval_iceberg_008_4
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu/retrieval_iceberg/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu/retrieval_iceberg/%x_%j.err

# SIMBA+ICEBERG retrieval for 008_4 (head_mode=distance_linear_head), checkpoint=checkpoint-epoch=02-step=27000.ckpt.
...
echo "===== SIMBA+ICEBERG Retrieval: 008_4 (head_mode=distance_linear_head) ====="
