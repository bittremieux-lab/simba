#!/bin/bash
#SBATCH -J simba_train_meta_ce_v2
#SBATCH -p one_day
...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_meta_ce_v2_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_meta_ce_v2_%j.err

# clip-40 + metadata, CE fix applied (reads collision_energy key, handles floats)
# + CE normalized by /100 in encoder. MCES sampling bug also fixed.
# 8 epochs (~80k steps) comparison vs control (no CE fix).

set -uo pipefail

echo "===== SIMBA Training: MSG scaffold split — metadata, CE fix + normalization (v2) ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_scaffold_split_mces40_metadata_ce_v2
