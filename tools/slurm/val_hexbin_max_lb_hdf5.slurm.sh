#!/bin/bash
#SBATCH -J simba_inf_max_lb_hdf5
#SBATCH -p one_hour
...
#SBATCH --mem=80G
#SBATCH -o /home/nkubrakov/simba/logs/simba_inf_max_lb_hdf5_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_inf_max_lb_hdf5_%j.err

set -uo pipefail

echo "===== Inference: max(Gaetan lb, HDF5) @ step 70k ====="
...
CHECKPOINT="${EXP_DIR}/checkpoint-epoch=06-step=70000.ckpt"
OUTPUT_DIR="${EXP_DIR}/val_hexbin_step70k"
