#!/bin/bash
#SBATCH -J simba_train_014_2_budget7564_T10
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T10_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T10_1gpu/%x_%j.err
...
# the other 16,446, same count for every T). T=10 (this file) means a
# minimum-distance floor of 10 on top of the closest-to-CASMI selection --
# distance range [10.0, 14.5] (verified when the exclusion
...
echo "===== SIMBA Training 014_2 budget-matched sweep, T=10 (7,564 closest-to-CASMI train molecules, min_dist>=10) ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T10_1gpu
EXCLUDE_FILE=/sofia/projects/2026_053/simba_project/data/analog_discovery/train_exclude_smiles_budget7564_T10.txt
