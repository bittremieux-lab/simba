#!/bin/bash
#SBATCH -J simba_train_014_2_casmi_excl4
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl4_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl4_1gpu/%x_%j.err

# CASMI-distance-exclusion sweep (threshold=4) (see NOTES_014_2_ANALOG_DISCOVERY.md,
...
#     molecule whose min GT-MCES distance to any CASMI query is < 4 (see
...
#     val/test untouched). 982 / 24,010 train molecules excluded, leaving
#     23028 -- see the job log for the exact "kept X / Y pairs" count from
...
echo "===== SIMBA Training 014_2 CASMI-excl4 (train molecules < MCES 4 from any CASMI query dropped) ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl4_1gpu
EXCLUDE_FILE=/sofia/projects/2026_053/simba_project/data/analog_discovery/train_exclude_smiles_threshold4.txt
