#!/bin/bash
#SBATCH -J simba_train_own_val_weights
#SBATCH -p one_day
...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_own_val_weights_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_own_val_weights_%j.err

# Same as job 8011 but val/val_official samplers use their own inverse-frequency
# bin weights instead of train's. No early stopping — manual inspection.

set -uo pipefail

echo "===== SIMBA Training: exact MCES [10-20] · no metadata · own val weights ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_exact_mces_1020_no_meta_own_val_weights
