...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_sv2_both_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_sv2_both_%j.err

set -uo pipefail

echo "===== SIMBA Training: scaffold_v2 — ED + MCES (both objectives) ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/scaffold_v2_both
...
uv run simba train \
  ...
  model.tasks.edit_distance.enabled=true
