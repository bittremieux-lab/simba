#!/bin/bash
#SBATCH -J simba_train_014_2_casmi_excl12
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl12_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl12_1gpu/%x_%j.err

# CASMI-distance-exclusion pilot (see NOTES_014_2_ANALOG_DISCOVERY.md,
...
#     molecule whose min GT-MCES distance to any CASMI query is < 12 (see
...
#     val/test untouched). 13,277 / 24,010 train molecules excluded, leaving
#     10,733 -- see the job log for the exact "kept X / Y pairs" count from
...
echo "===== SIMBA Training 014_2 CASMI-excl12 (train molecules < MCES 12 from any CASMI query dropped) ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl12_1gpu
EXCLUDE_FILE=/sofia/projects/2026_053/simba_project/data/analog_discovery/train_exclude_smiles_threshold12.txt
