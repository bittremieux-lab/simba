#!/bin/bash
#SBATCH -J simba_retrieval_008_4_distance_linear_head_1gpu
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu/retrieval_best_official_spearman/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu/retrieval_best_official_spearman/%x_%j.err

# Retrieval eval for 008_4_distance_linear_head_1gpu (head_mode=distance_linear_head), using the checkpoint at
# this run's own best val_mces_spearman/official point (found from
# metrics.csv, not the scaffold-loss-selected best_model.ckpt): checkpoint-epoch=02-step=27000.ckpt.
...
echo "===== SIMBA Retrieval: 008_4_distance_linear_head_1gpu (head_mode=distance_linear_head), checkpoint=checkpoint-epoch=02-step=27000.ckpt ====="
...
EXPERIMENT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/008_4_distance_linear_head_1gpu
OUTPUT_DIR="${EXPERIMENT_DIR}/retrieval_best_official_spearman"
CHECKPOINT="${EXPERIMENT_DIR}/checkpoint-epoch=02-step=27000.ckpt"
...
uv run python tools/simba_retrieval.py \
    ...
    --split test \
    --batch_size 512 \
    --head_mode distance_linear_head \
