#!/bin/bash
#SBATCH -J simba_train_014_2_casmi_excl8
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl8_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl8_1gpu/%x_%j.err

# CASMI-distance-exclusion sweep (threshold=8) (see NOTES_014_2_ANALOG_DISCOVERY.md,
...
#     molecule whose min GT-MCES distance to any CASMI query is < 8 (see
...
#     val/test untouched). 6795 / 24,010 train molecules excluded, leaving
#     17215 -- see the job log for the exact "kept X / Y pairs" count from
...
echo "===== SIMBA Training 014_2 CASMI-excl8 (train molecules < MCES 8 from any CASMI query dropped) ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_excl8_1gpu
EXCLUDE_FILE=/sofia/projects/2026_053/simba_project/data/analog_discovery/train_exclude_smiles_threshold8.txt
