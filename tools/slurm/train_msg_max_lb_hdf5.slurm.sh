...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_max_lb_hdf5_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_max_lb_hdf5_%j.err

set -uo pipefail

echo "===== SIMBA Training: MSG splits, max(Gaetan lb, HDF5) distances, clip-40 ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_max_lb_hdf5_mces40
