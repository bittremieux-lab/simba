...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_meta_ce_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_meta_ce_%j.err

# clip-40 + metadata, CE bug fixed (loader now reads collision_energy as fallback for ce).
# Same preprocessing as original metadata run. 8 epochs ≈ 80k steps.

set -uo pipefail

echo "===== SIMBA Training: MSG scaffold split — metadata, CE fixed ====="
...
OUTPUT_DIR=/mnt/data/nkubrakov/experiments_3_dataset/training/msg_scaffold_split_mces40_metadata_ce
