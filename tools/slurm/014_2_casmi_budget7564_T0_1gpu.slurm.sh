#!/bin/bash
#SBATCH -J simba_train_014_2_budget7564_T0
#SBATCH -p zen4_h200
...
#SBATCH -o /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T0_1gpu/%x_%j.out
#SBATCH -e /sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T0_1gpu/%x_%j.err
...
# the other 16,446, same count for every T). T=0 (this file) means no
# minimum-distance floor, so it's simply the 7,564 molecules closest to
# CASMI overall -- distance range [0.0, 8.0] (verified when the exclusion
...
echo "===== SIMBA Training 014_2 budget-matched sweep, T=0 (7,564 closest-to-CASMI train molecules) ====="
...
OUTPUT_DIR=/sofia/projects/2026_053/simba_project/experiments/training/014_2_casmi_budget7564_T0_1gpu
EXCLUDE_FILE=/sofia/projects/2026_053/simba_project/data/analog_discovery/train_exclude_smiles_budget7564_T0.txt
