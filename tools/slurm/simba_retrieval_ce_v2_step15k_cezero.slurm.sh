#!/bin/bash
#SBATCH -J simba_ret_ce_v2_15k_ce0
#SBATCH -p one_day
...
#SBATCH --mem=64G
#SBATCH -o /home/nkubrakov/simba/logs/simba_ret_ce_v2_step15k_cezero_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_ret_ce_v2_step15k_cezero_%j.err
...
INTERMEDIATES_DIR=/mnt/data/nkubrakov/experiments_3_dataset/retrieval/msg_ce_v2_step15k_cezero
OUTPUT_TSV=/home/nkubrakov/simba/results/simba_retrieval_ce_v2_step15k_cezero.tsv

mkdir -p /home/nkubrakov/simba/results

echo "===== SIMBA Retrieval: CE v2 step 15k · CE=0 diagnostic ====="
