#!/bin/bash
#SBATCH -J simba_train_own_val_bs2048
#SBATCH -p one_day
...
#SBATCH --mem=180G
#SBATCH -o /home/nkubrakov/simba/logs/simba_train_own_val_bs2048_%j.out
#SBATCH -e /home/nkubrakov/simba/logs/simba_train_own_val_bs2048_%j.err

# Same as job 8041 (own val weights, no early stopping, exact MCES, no metadata)
# but batch_size=2048; lr=0.0001 unchanged.
