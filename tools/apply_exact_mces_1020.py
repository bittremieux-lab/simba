...
For each split, the script:
  1. Loads the original ed_mces_indexes_tani_incremental_{split}_*.npy (base: max(lb_matrix, HDF5)).
...
Run on a machine with sufficient RAM (the login node may not have enough).
"""
