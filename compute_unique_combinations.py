...
input_dataset_path= '/scratch/antwerpen/209/vsc20939/data/merged_gnps_nist_20240112.pkl'
...
# add info to 
new_molecule_pairs_train= MolecularPairsSet(spectrums=molecule_pairs_train.spectrums,
                                            indexes_tani= np.concatenate((molecule_pairs_train.indexes_tani, indexes_np_train), axis=0))
new_molecule_pairs_val= MolecularPairsSet(spectrums=molecule_pairs_val.spectrums,
                                            indexes_tani= np.concatenate((molecule_pairs_val.indexes_tani, indexes_np_val), axis=0))
write_data(output_dataset_path, 
                        all_spectrums_train=None, 
                        all_spectrums_val=None, 
                        all_spectrums_test=None, 
